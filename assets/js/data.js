...
const SCIENCE = [
  { q:"化粧水って、結局“意味ない”の？",
    a:"言い過ぎ。保湿成分入りなら水分は上がるが、<strong>単体では持続が短い</strong>。だから乳液やオイルでフタを。化粧水は主役でなく<strong>導入役</strong>。" },
  { q:"高い化粧水ほど効くの？",
    a:"価格と効果は比例しない。大きな分子（高分子コラーゲン・ヒアルロン酸・プラセンタ等）は角質を通れず<strong>表面止まり</strong>（分子量500超は入りにくい＝500ダルトンの目安／Bos & Meinardi, 2000）。値段より<strong>成分</strong>で選ぶ。" },
  { q:"「幹細胞」「成長因子」ってすごいの？",
    a:"入っているのは生きた細胞でなく<strong>培養液エキス</strong>。塗って再生はしない。成長因子も分子が大きく<strong>浅い層まで</strong>。誇大広告に注意。" },
  { q:"バリア機能って何？",
    a:"角質層は<strong>レンガ（細胞）とモルタル（脂質）</strong>の構造。崩れると水分が逃げ（TEWL上昇）、乾燥や炎症に。<strong>セラミド</strong>がモルタルを補う。" },
  { q:"どんな順番で塗ればいい？",
    a:"基本は<strong>水分 → 油分</strong>。脂性・混合肌は化粧水→ジェル→（夜）オイル、乾燥肌は化粧水→乳液→オイル。<strong>朝は最後に日焼け止め</strong>。" },
];
